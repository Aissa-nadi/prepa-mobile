...
public class SqlLiteDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.createDefaultCarsIfNeed();

        List<Car> list=  db.getAllCars();
        this.carList.addAll(list);

        listViewAdapter = new ArrayAdapter<Car>(this,
    ...
    public void onCreateContextMenu(ContextMenu menu, View view,
        ...
        menu.add(0, MENU_ITEM_VIEW , 0, "View Car");
        menu.add(0, MENU_ITEM_CREATE , 1, "Create Car");
        menu.add(0, MENU_ITEM_EDIT , 2, "Edit Car");
        menu.add(0, MENU_ITEM_DELETE, 4, "Delete Car");
    }
